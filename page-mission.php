...
<article class="hp-mission" aria-label="<?php the_title_attribute(); ?>">
    ...
    <div class="hp-mission__body">
        ...
        <div class="hp-mission__prose prose">
            ...
            <p>Im Zeitalter der Künstlichen Intelligenz wird diese Frage dringlicher. Wenn Maschinen leisten, was bisher Menschen leisteten, verschiebt sich die Frage von Können auf Sein. Die kapitalistische Logik hat darauf eine klare Antwort: Was effizienter ersetzt werden kann, verliert an Wert. Der Mensch wird, gemessen an den Maßstäben des Systems, überflüssig — nicht weil er es ist, sondern weil das System nur in Verwertung denkt.</p>
