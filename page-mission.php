...
<article class="hp-mission" aria-label="<?php the_title_attribute(); ?>">
    ...
    <div class="hp-mission__body">
        ...
        <div class="hp-mission__prose prose">
            ...
            <p>Geboren in Nordkurdistan – in den Regionen, die der türkische Staat als seinen Südosten beansprucht. Aufgewachsen in Deutschland. Drei Sprachen, drei Welten, keine davon neutral.</p>

            <p>Kurdisch ist die Sprache, die mir gehört und die ein Staat mir nehmen wollte. Mehr als das: Sie ist eine Art, Wirklichkeit zu ordnen, Beziehungen zu knüpfen, Erinnerung zu bewahren – eine ganze Welt, die ausgelöscht werden sollte. Türkisch ist die Sprache, die an ihre Stelle gesetzt wurde – nicht nur als Kommunikationsmittel, sondern als andere Logik, Zugehörigkeit zu definieren und Vergangenheit zu formatieren. Deutsch ist die Sprache, in der ich gelernt habe, beides zu benennen – nicht von außen, sondern aus der Spannung zwischen ihnen. Jede dieser Sprachen trägt eine Machtgeschichte, jede organisiert Wirklichkeit anders. Zusammen formen sie den Blick, aus dem heraus ich schreibe.</p>

            <p>Was mich antreibt, beginnt beim eigenen Dasein: bei der Erfahrung, dass die Welt, in die man geworfen wird, nicht zufällig geordnet ist, sondern hierarchisch. Aus dieser Erfahrung werden Fragen: Was geschieht mit Erinnerung in Gesellschaften, die von oben organisiert sind? Wie formt staatliche Macht, was gedacht und gesagt werden darf? Und wer bestimmt, welche Fragen überhaupt gestellt werden?</p>

            <p>Und dann ist da die Frage nach der Freiheit – nicht als Ideal, sondern als Problem. Was bedeutet Freiheit, wenn die Realität, in der sie stattfinden soll, monopolistisch verfasst ist? Ein System, das Ordnung durch Unterordnung herstellt, beeinflusst nicht nur, wer frei ist – es formt, was Freiheit überhaupt bedeuten darf. Der Begriff selbst wird zum Produkt der Verhältnisse, die ihn begrenzen.</p>

            <p>Ich glaube: Wenn Menschen erkennen, dass sie frei sind – jenseits der Ordnung, die ihnen ihre Stelle zuweist –, dann sind sie es auf der Stelle. Nicht weil das System verschwindet, sondern weil es seine Selbstverständlichkeit verliert. Freiheit beginnt dort, wo das Bewusstsein dem System zuvorkommt. Das ist kein idealistischer Kurzschluss. Es ist eine existenzielle Tatsache: Der Mensch hat immer einen Spalt Abstand zu dem, was ihn bestimmt. Und in diesem Spalt beginnt alles.</p>

            <p>Doch Freiheit, die nur individuell gedacht wird, reproduziert die Isolation, die sie überwinden will. Sie braucht eine Form, in der sie gelebt werden kann – gemeinsam. Die Antwort auf konzentrierte Macht ist geteilte Macht: Organisation von unten, in der Menschen ihre Angelegenheiten selbst in die Hand nehmen. Räte, Versammlungen, Selbstverwaltung – nicht als fertiges Modell, sondern als tägliche Praxis. Kommunal organisierte Freiheit ist kein Zustand, den man erreicht, sondern ein Prinzip, das man übt.</p>

            <p>Freiheit ist zugleich abstrakt und konkret – ein philosophischer Begriff und eine gelebte Bedingung. Mehr noch: Sie ist ein Organisationsprinzip. Nicht etwas, das man hat, sondern etwas, das man tut – immer wieder, im Einzelnen und im Miteinander. Wie ein Organismus, der sich durch ständigen Austausch mit seiner Umwelt erhält, sich abgrenzt, ohne getrennt zu sein, auf Bedingungen reagiert und sie zugleich umgestaltet.</p>

            <p>Wenn einzelne Menschen das erkennen, ist das ein Anfang. Wenn viele es erkennen und beginnen, es gemeinsam zu praktizieren, entsteht etwas Neues: ein gemeinsames Bewusstsein, das nicht verordnet wird, sondern wächst – aus geteilter Erfahrung, aus Verbindung, aus dem Mut, die Selbstverständlichkeit des Gegebenen gemeinsam zu verlernen. Aus diesem Bewusstsein kann gemeinsames Handeln werden. Nicht linear, nicht garantiert – aber möglich. Und es hat eine Richtung: hin zu einer Macht, die nicht besessen, sondern ausgeübt wird – von allen, die sie angeht.</p>
